...
void TestAbsolute()
{
    ArmModel armModel = new ArmModel(Length.FromMillimeters(168), Length.FromMillimeters(95), Length.FromMillimeters(101), Length.FromMillimeters(65));
    PositionMove positionMove = new PositionMove(armModel, controller);

    positionMove.MoveTo(new Position() { X = Length.FromMillimeters(0), Y = Length.FromMillimeters(0), Z = Length.FromMillimeters(428) });

    positionMove.MoveTo(new Position() { X = Length.FromMillimeters(0), Y = Length.FromMillimeters(0), Z = Length.FromMillimeters(300) });
